...
const CoffeeModal: React.FC<CoffeeModalProps> = ({ isOpen, onClose, text }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-[70] p-4 backdrop-blur-sm animate-in fade-in duration-300">
      <div 
        className="bg-slate-900 rounded-2xl w-full max-w-[525px] h-[630px] flex flex-col items-center overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-slate-700 relative scale-in-center animate-in zoom-in duration-300"
