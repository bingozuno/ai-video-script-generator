...
// =========================================================================
// === SỬA LỖI: CẬP NHẬT PROMPT HỆ THỐNG (LOGIC "MỘT TRONG HAI" + "SAO CHÉP & THÍCH NGHI") ===
// =========================================================================
...
**TỐI HẬU THƯ VỀ NHẤT QUÁN NHÂN VẬT (TUÂN THỦ TUYỆT ĐỐI - PHIÊN BẢN 5.0)**
...
* \`Định nghĩa Nhân vật (văn bản)\`: (Ô to)
* \`Tham Chiếu Nhân vật (hình ảnh)\`: (Các ô nhỏ màu vàng)

**QUY TẮC ƯU TIÊN NGUỒN (CHỈ CHỌN MỘT):**
* **ƯU TIÊN 1:** Bạn PHẢI kiểm tra trường \`Tham Chiếu Nhân vật (hình ảnh)\` trước tiên. Nếu trường này **CÓ** nội dung (không trống), nó sẽ trở thành "Nguồn Chân Lý" của bạn.
* **ƯU TIÊN 2:** Nếu (và CHỈ NẾU) trường \`Tham Chiếu Nhân vật (hình ảnh)\` **TRỐNG**, bạn BẮT BUỘC phải sử dụng trường \`Định nghĩa Nhân vật (văn bản)\` làm "Nguồn Chân Lý".
* Nếu cả hai đều trống, bạn không cần mô tả nhân vật.
...
* **BƯỚC 1: TÌM NGUỒN CHÂN LÝ**
    * TÌM mô tả của 'Haruka Sato' trong "Nguồn Chân Lý" mà bạn đã xác định ở trên (Ưu tiên 1 hoặc Ưu tiên 2).
...
1.  **Bảng Phân cảnh:** Trình bày dưới dạng bảng Markdown. BẮT ĐẦU VỚI DÒNG "### Bảng Phân cảnh". Bảng phải có 5 cột với tiêu đề chính xác như sau: "STT/Phân cảnh", "Thời gian (8 giây)", "Mô tả Kịch bản Chi tiết", "Prompt Tạo Ảnh (Whisk AI)", "Prompt Tạo Chuyện động (Veo 3.1)".
    ...
    * **Prompt Tạo Chuyện động (Veo 3.1):** Prompt riêng biệt bằng **TIẾNG ANH**, phải là một chuỗi JSON hợp lệ.
...
//  analyzeCharacterImage, generateImagesFromPrompt, generateScript, v.v... 
...
export const generateScript = async (
  ...
  try {
    ...
    // Nguồn B: Các ô nhỏ (Nguồn Chân Lý Ưu Tiên)
